...
import com.peliculas.peliculasapp.infrastructure.adapter.entities.*;
...
@Component
public class TvSeriesEntityMapper implements DomainEntityMapper<TvSeries, TvSeriesEntity>{
